...
export class StartpageComponent {
  ...
  caption: string[] =[
   ...
   text: string[] =[
    'Tobias Ullrich',
    '"Das Entscheidende am Wissen ist, dass man es beherzigt und anwendet." - Konfuzius MEHR',
    '"Wenn du den Mechanismus verstehst, ist die Behandlung einfach." - W. G. Sutherland MEHR',
